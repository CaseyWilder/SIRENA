...
class AmazonConfigSettings(models.TransientModel):
    ...
    amz_instance_removal_order = fields.Many2one('amazon.instance.ept',
                                                 string='Removal Order Instance',
    ...
    amz_reimbursement_product_id = fields.Many2one("product.product",
    ...
    amz_outbound_instance_id = fields.Many2one('amazon.instance.ept',
                                               string='Default Outbound Instance',
    ...
    def onchange_amz_seller_id(self):
        ...
        if self.amz_seller_id:
            ...
            seller = self.amz_seller_id
            self.env['amazon.instance.ept'].search([('seller_id', '=', self.amz_seller_id.id)])
            ...
            vals['value'][
                'amz_fba_order_prefix'] = seller.fba_order_prefix and seller.fba_order_prefix
            ...
            removal_instance_id = seller.instance_ids.filtered( \
                lambda r: r.is_allow_to_create_removal_order)
            ...
            if seller.allow_auto_create_outbound_orders:
                vals["value"][
                    "allow_auto_create_outbound_orders"] = seller.allow_auto_create_outbound_orders
    ...
    def onchange_amz_instance_id(self):
        ...
        if instance:
            ...
            values[
                'amz_instance_pricelist_id'] = instance.pricelist_id.id if \
