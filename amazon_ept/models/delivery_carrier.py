...
class DeliveryCarrier(models.Model):
    ...
    amz_shipping_service_level_category = fields.Selection(
        ...
        string="Amazon Shipping method(FBM,FBA)", default='Standard', help="Amazon Shipping Categories")

    amz_outbound_shipping_level_category = fields.Selection(
        [('Expedited', 'Expedited'), ('Standard', 'Standard'), ('Priority', 'Priority')], default='Standard',
